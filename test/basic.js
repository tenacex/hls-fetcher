...
test('parseResource playlist test 1', function (t) {
	var tagLine = "#EXT-X-STREAM-INF:PROGRAM-ID=1,BANDWIDTH=240000";
	var resourceLine = "prog_index.m3u8";
	var manifestUri = "http://example.com/hls_manifest.m3u8";
	var resource = parse.parseResource(tagLine, resourceLine, manifestUri);
...
test('parseResource playlist test 2', function (t) {
	var tagLine = "#EXT-X-STREAM-INF:PROGRAM-ID=1,BANDWIDTH=440000";
	var resourceLine = "prog_index2.m3u8";
	var manifestUri = "http://example.com/hls_manifest.m3u8";
	var resource = parse.parseResource(tagLine, resourceLine, manifestUri);
    t.plan(2);
    t.equal(resource.type, 'playlist');
...
test('parseResource segment test 1', function (t) {
	var tagLine = "#EXTINF:10, no desc";
	var resourceLine = "fileSequence0.ts";
	var manifestUri = "http://example.com/hls_manifest.m3u8";
	var resource = parse.parseResource(tagLine, resourceLine, manifestUri);
    t.plan(2);
...
test('parseResource segment test 2', function (t) {
	var tagLine = "#EXTINF:10, no desc";
	var resourceLine = "http://example.com/hls_manifest.m3u8/fileSequence0.ts";
	var manifestUri = "http://example.com/hls_manifest.m3u8";
	var resource = parse.parseResource(tagLine, resourceLine, manifestUri);
    t.plan(2);
    t.equal(resource.type, 'segment');
...
test('parseManifest test 1', function (t) {
	...
	var manifestUri = "http://example.com/hls_manifest.m3u8";
	var manifestData = "#EXTM3U\n#EXT-X-TARGETDURATION:10\n#EXT-X-MEDIA-SEQUENCE:0\n#EXTINF:10, no desc\nfileSequence0.ts\n#EXTINF:10, no desc\nfileSequence1.ts\n#EXT-X-ENDLIST";
	var manifestLines = parse.parseManifest(manifestUri, manifestData);
...
test('getCWDName test 1', function (t) {
	var line = "http://example.com/hls_manifest.m3u8/fileSequence0.ts";
	var uri = "http://example.com/hls_manifest.m3u8";
...
test('createManifestText test 1', function (t) {
	...
	var uri = "http://example.com/hls_manifest.m3u8";
	var manifestData = "#EXTM3U\n#EXT-X-TARGETDURATION:10\n#EXT-X-MEDIA-SEQUENCE:0\n#EXTINF:10, no desc\nfileSequence0.ts\n#EXTINF:10, no desc\nfileSequence1.ts\n#EXT-X-ENDLIST";
	var manifestLines = parse.parseManifest(uri, manifestData);
